import 'package:all_in_all/common/common.dart';
import 'package:all_in_all/data/api/apis.dart';
import 'package:all_in_all/data/net/dio_util.dart';
import 'package:all_in_all/data/protocol/models.dart';
...
class WanRepository {
  ...
  Future<List<ReposModel>> getArticleListProject(int page) async {
    BaseResp<Map<String, dynamic>> baseResp = await DioUtil().request<Map<String, dynamic>>(
      Method.get,
      WanAndroidApi.getPath(path: WanAndroidApi.ARTICLE_LISTPROJECT, page: page)
    );
